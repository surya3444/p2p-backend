...
// --- APP & SERVER SETUP ---
const app = express();
const whitelist = ['http://localhost:5173', 'http://localhost:4173', 'https://p2p-cloud-server.vercel.app', 'https://p2p-cloud-server-dik66oogo-suryas-projects-dfcfd390.vercel.app'];
const corsOptions = {
